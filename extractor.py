...
def extract(text: str) -> tuple[Motherboard, anthropic.types.Usage]:
    ...
    response = client.messages.create(
        ...
        system=(
            ...
            "Include the key type and supported interface (e.g. 'M.2 2280 PCIe 5.0 x4', "
            "'M.2 2280 PCIe 4.0 x4', 'M.2 2242 SATA/PCIe'). Note the PCIe generation "
            "and whether SATA is supported if mentioned.\n"
