...
def extract(text: str) -> tuple[Motherboard, anthropic.types.Usage]:
    ...
    response = client.messages.create(
        ...
        system=(
            ...
            "Use the verbal generation format: 'M.2 Gen5x4', 'M.2 Gen4x4'. "
            "If a slot supports SATA, append it: 'M.2 Gen4x4/SATA'. "
            "Always use Gen<number>x<lanes> (e.g. Gen5x4, Gen4x4, Gen3x2), not 'PCIe 5.0 x4'. "
            "Do not include the form factor size (2280, 2242, etc.) in the type.\n"
