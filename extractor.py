...
_SYSTEM_PROMPT = (
    ...
    "(e.g. 'HDMI 2.1', 'DisplayPort 1.4', 'VGA', 'DVI-D'). No resolution, "
    "refresh rate, or other details.\n"
    ...
    "'Mic'). The main rear speaker output is 'Line Out', not 'Front Speaker' "
    "or 'Speaker Out'. Front panel audio typically comes from an 'HD Audio "
    "Header' or 'Front Panel Audio Connector'. Use location 'rear' or 'front'. "
    ...
    "Count physical jacks only — '7.1 channel audio' describes channel "
    "processing, not the number of jacks.\n"
