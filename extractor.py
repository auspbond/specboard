...
def extract(text: str) -> tuple[Motherboard, anthropic.types.Usage]:
    ...
    response = client.messages.create(
        ...
        system=(
            ...
            "Field guidance:\n"
            "- graphics_chip: The integrated/onboard graphics chip if the board has one "
            "(e.g. from the CPU's iGPU output). Use null if the board has no video output "
            "capability or relies entirely on a discrete GPU.\n"
            ...
            "'M.2 2242 Gen4x4'. If a slot supports SATA, append it: 'M.2 2280 Gen4x4/SATA'. "
