...
- **92–96% field-level accuracy** across runs (190 fields scored). Scoring is strict: one wrong entry in a list field (e.g., missing a USB port) fails the entire field.
